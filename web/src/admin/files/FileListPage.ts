                                    ...
                                    <select
                                        ...
                                        @change=${(ev: Event) => {
                                            this.usage = (ev.target as HTMLSelectElement)
                                                .value as AdminFileListUsageEnum;
                                            this.page = 1;
                                            this.fetch();
                                        }}
                                    >
                                        <option value=${AdminFileListUsageEnum.Media}
                                            ?selected=${this.usage === AdminFileListUsageEnum.Media}>
                                            ${msg("Media")}
                                        </option>
                                        <option value=${AdminFileListUsageEnum.SamlMetadata}
                                            ?selected=${this.usage === AdminFileListUsageEnum.SamlMetadata}>
                                            ${msg("SAML metadata")}
                                        </option>
                                    </select>
                                </div>
